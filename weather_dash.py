...
if not data.empty:
    ...
    if not filtered_data.empty:
        ...
        filtered_data = filtered_data.set_index("created_at").resample("2h").mean(numeric_only=True).reset_index()
        ...
        pm25_fig = px.line(filtered_data, x="created_at", y="PM2.5", markers=True,
                            title="PM2.5 Over Time (2-Hour Intervals)")
        ...
        pm10_fig = px.line(filtered_data, x="created_at", y="PM10", markers=True,
                            title="PM10 Over Time (2-Hour Intervals)")
        ...
        ozone_fig = px.line(filtered_data, x="created_at", y="Ozone", markers=True,
                             title="Ozone Over Time (2-Hour Intervals)")
        ...
        co_fig = px.line(filtered_data, x="created_at", y="CO", markers=True,
                          title="CO Over Time (2-Hour Intervals)")
